...
All notes, notebooks, and settings are stored exclusively in **Chrome Sync** (`chrome.storage.local.sync`) — Google's built-in storage for extension data. This data is tied to your Google account and subject to [Google's Privacy Policy](https://policies.google.com/privacy).
